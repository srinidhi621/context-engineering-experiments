#!/usr/bin/env python3
"""Attempt to build the 950k RAG index for Exp2 (no generation).
Note: With current 512-word chunks, this needs ~1,576 embedding calls and may hit the daily RPD cap before finishing.
"""
...
logger = get_logger("rag_builder_950k_resume")
